! function(a) {
    ...
    }), a("#maxAmount").val(a("#slider-range").slider("value")), a("#video-container").modalVideo({
        youtube: {
            controls: 0,
            nocookie: !0
        }
    }), a(".counter").counterUp(), a(".quantity").prop("disabled", !0), a(document).on("click", ".plus-btn", function(b) {
